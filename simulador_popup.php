<?
$pageTitle = "Simulador";
include "lib/header_popup.inc.php";
...
$f_reduc_lbl = '&nbsp;';
$f_reduc_val = '&nbsp;';
$display_usar_dados = 'display:none;';
...
?>
        ...
        <tr>
          ...
          <td align="left">
            <b>
            <input type="hidden" name="usarValFin" id="usarValFin" value="<?=$_POST['usarValFin'];?>" />
        ...
        <tr>
          <td align="right">&nbsp;</td>
          <td align="left">
          	<input type="image" src="images/buttons/bt_calcular.gif" value="Calcular" class="im" />
          	<img src="images/buttons/bt_usar_dados.gif" alt="" onclick="usarDadosRun();" class="cursorMao" id="usarDados" style="<?=$display_usar_dados;?>" />
         </td>
        </tr>
      </table>
		</div>
...
<?
include "lib/footer_popup.inc.php";
?>