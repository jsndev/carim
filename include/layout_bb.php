	...
	<div id="boleto">
		...
		<tr class="campos">
			...
			<td class="valor_doc">				<?php 
				if($typ=='sv'){
					$vll=str_replace(".",",",str_replace(",",".",$dadosboleto["valor_boleto"]));
					$vt=explode(",",$vll);
					if($vt[1]=='')
					{
						$teste=formataM($vll).",00";
						echo $teste;
					}else{
						$teste=explode(",",$vll);
						echo formataM($teste[0]).",".$teste[1];
					}
				}elseif($typ=='pp'){
					$vll=str_replace(".",",",str_replace(",",".",$dadosboleto["valor_boleto"]));
					$vt=explode(",",$vll);
		...
		<tr class="campos">
			...
			<td class="outros_acrescimos" align="center">&nbsp;</td>
			<td class="valor_cobrado" align="right">				<?php 
				if($typ=='sv'){
					$vll=str_replace(".",",",str_replace(",",".",$dadosboleto["valor_boleto"]));
					$vt=explode(",",$vll);
					if($vt[1]=='')
		...
		<tr class="campos">
			...
			<td class="valor_doc2"><?php 
				if($typ=='sv'){
					...
					$vll=str_replace(".",",",str_replace(",",".",$dadosboleto["valor_boleto"])+0);
					$vt=explode(",",$vll);
					if($vt[1]=='')
					{
						$teste=formataM($vll).",00";
		...
		<tr><td>
			...
			<tr class="campos">
				<td class="outros_acrescimos2" align="right">&nbsp;</td>
			</tr>
			</tbody>
			</table>
		</td></tr>
		...
		<tr><td class="last_line">
			...
			<tr class="campos">
				<td class="valor_cobrado2" align="right">
				<?php 
				if($typ=='sv'){
					$vll=str_replace(".",",",str_replace(",",".",$dadosboleto["valor_boleto"]));
					$vt=explode(",",$vll);
