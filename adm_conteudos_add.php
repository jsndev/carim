...
<div class="quadroInterno">
	...
	<div class="quadroInternoMeio">
		...
		<table cellpadding="0" cellspacing="2" class="tbForm" border="0">
			...
			<tr>
				<td>&nbsp;</td>
				<td class="alr"><img src="images/buttons/bt_voltar.gif" onclick="goPage('adm_conteudos.php')" alt="Cancelar e voltar" class="cursorMao" />&nbsp;<img src="images/buttons/bt_salvar.gif" onclick="validaConteudo(document.getElementById('frm1'),'<? echo $crypt->encrypt("adicionar");?>');" alt="Inserir Conteúdo" class="cursorMao" /></td>
			</tr>
		</table>
	</div>
