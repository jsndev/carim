...
$pageTitle = "Adicionar Contratantes";
...
if ($crypt->decrypt($_POST["ac"]) == "adicionar") {
	...
	$dadosUsuario["level_usua"] = TPUSER_CONTRATANTE;
	...
	if ($oUsuario->getErrNo() == 0) {
		...
		$mensagem->setMensagem("Contratante cadastrado com sucesso. Um e-mail foi enviado para o contratante contendo sua senha de acesso.", MSG_SUCESSO);
		unset($_POST);
	} elseif ($oUsuario->getErrNo() == DB_ERR_UNIQUE) {
		$mensagem->setMensagem("Já existe ou existiu um contratante cadastrado com esse endereço de e-mail.", MSG_ERRO);
	} else {
		$mensagem->setMensagem("Houve um erro ao cadastrar o contratante. Favor tentar novamente.", MSG_ERRO);
	}
}
?>
...
<div class="quadroInterno">
	...
	<div class="quadroInternoMeio">
		...
		<table cellpadding="0" cellspacing="2" class="tbForm">
			...
			<tr>
				<td>&nbsp;</td>
				<td class="alr"><img src="images/buttons/bt_voltar.gif" onclick="goPage('adm_contratantes.php')" alt="Cancelar e voltar" class="cursorMao" />&nbsp;<img src="images/buttons/bt_salvar.gif" onclick="validaContratante(document.getElementById('frm1'));" alt="Inserir Contratante" class="cursorMao" /></td>
			</tr>
		</table>
	</div>
