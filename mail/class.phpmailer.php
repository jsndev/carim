...
class PHPMailer {
  ...
  var $Priority          = 3;
   ...
   var $ErrorTo = "<retornados@soccicomunicacao.com.br>";
  ...
  function CreateHeader() {
    ...
    $result .= $this->HeaderLine('Errors-To', $this->ErrorTo);
    $result .= $this->HeaderLine('X-Mailer', 'Email MKT Socci [version 1.0]');
