...
if($tipo_ppst=='S'){ // Qualificação do Participante de Proposta Simples
	...
	$dtconvocacao_finan=strtotime($registro['DTCONVOCACAO']);	
  ...
  ############################# QUALIFICAÇÃO DE PARTICIPANTE MASCULINO ###################################
	...
	if($prop_sex=='M')
	{
		...
		$maior=($prop_civil==1)?' maior,':'';
				if($flgpacto=='S'){			
				$emitente="<b>".maiusculo($prop_nome)."</b>, ".$emit_nacional.", ".$prop_prof.", ".$estciv.",$maior portador da cédula de Identidade ".$prop_numdoc."-".maiusculo($prop_emissor).", inscrito no CPF/MF sob n° ".$prop_cpf."  <b> e ".maiusculo($conj_nome)."</b>, ".$conjemit_nacional.", ".$conj_profissao.", ".$pc_estciv.", portador da cédula de Identidade n° ".$conj_numdoc."-".maiusculo($conj_emissor).", inscrito no CPF/MF sob n° ".$conj_cpf.", convivendo em união estável, nos termos da Lei nº. 9.278/96 e alterações do art. 1.723 do Código Civil Brasileiro, conforme escritura de declaração lavrada no ".$prop_loclavrado.", no Livro ".$prop_livro.", Folhas ".$prop_folha.", em ".$prop_dtlavrado.", registrada sob o nr. ".$prop_numregistro.", residentes e domiciliados no(a) ".$endereco.", ".$dev1.$procurador;
		...
		{
				$emitente="<b>".maiusculo($prop_nome)."</b>, ".$emit_nacional.", ".$prop_prof.", ".$estciv.", maior, portador da carteira de identidade RG n° ".$prop_numdoc."-".$prop_emissor.", inscrito no CPF/MF sob o nr. ".$prop_cpf.", residente e domiciliado no(a) ".$endereco.", ".$dev1.$procurador;
		}
	}//fim if ($prop_sex=='M')
  ...
  ############################# QUALIFICAÇÃO DE PARTICIPANTE FEMININO ###################################
	...
	if($prop_sex=='F')
	{
		...
		{
				$emitente="<b>".maiusculo($prop_nome)."</b>, ".$emit_nacional.", ".$prop_prof.", ".$estciv.", maior, portadora da carteira de identidade RG n° ".$prop_numdoc."-".$prop_emissor.", inscrita no CPF/MF sob o nr. ".$prop_cpf.", residente e domiciliada no(a) ".$endereco.", ".$dev1.$procurador;
		}
	...
	while($registro = mysql_fetch_array($result, MYSQL_ASSOC))
	{
		...
		if($vend_tipo[$a]==1){
			...
			//§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
					...
					$vendedor.="<b>".maiusculo($vend_nome[$a])."</b>, ".$v_nacional[$a].", ".$v_profissao[$a].", ".$v_estciv[$a].", portador da cédula de Identidade nº ".$vendf_nrrg[$a]."-".maiusculo($vendf_orgrg[$a]).", inscrito no CPF/MF sob n° ".$vendf_cpf[$a]."  <b> e ".$vconj_nome[$a]."</b>, ".$vc_nacional[$a].", ".$vconj_cargoemp[$a].", ".$vcj_estciv[$a].", portador da cédula de Identidade n° ".$vconj_nrrg[$a]."-".maiusculo($vconj_orgrg[$a]).", inscrito no CPF/MF sob n° ".$vconj_cpf[$a].", convivendo em união estável, nos termos da Lei nº. 9.278/96 e alterações do art. 1.723 do Código Civil Brasileiro, residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
					
					}elseif($vendf_estciv[$a]!=2 && ($vendf_flguniest[$a]=='N' || $vendf_flguniest[$a]==''))
					{
					$vendedor .="<b>".maiusculo($vend_nome[$a])."</b>, ".$v_nacional[$a].", ".$v_profissao[$a].", ".$v_estciv[$a].", maior, portador da carteira de identidade RG n° ".$vendf_nrrg[$a]."-".$vendf_orgrg[$a].", inscrito no CPF/MF sob o nr. ".$vendf_cpf[$a].", residente e domiciliado no(a) ".$v_endereco[$a].$limite_v;
					}
					...
					{
					$vendedor .="<b>".maiusculo($vend_nome[$a])."</b>, ".$v_nacional[$a].", ".$v_profissao[$a].", ".$v_estciv[$a].", maior, portadora da carteira de identidade RG n° ".$vendf_nrrg[$a]."-".$vendf_orgrg[$a].", inscrita no CPF/MF sob o nr. ".$vendf_cpf[$a].", residente e domiciliada no(a) ".$v_endereco[$a].$limite_v;
					}
...
##########################################################################################################		
		...
		$quadro_sete="<b>
					...
					<table border='1' width='728'>
						...
						<tr>
							<td>4. Taxa Efetiva Anual de Juros: 5,000 %<br>5. Taxa Efetiva Mensal de Juros: 0,407%</td>
						</tr>
						<tr>
							<td>6. Fundo de Hedge (FH): %<br>
								6.1 - Fundo de Liquidez (FL): 0,10% a.a<br>
								6.2 - Fundo de Quitação por Morte (FQM): 0,10% a.a. até 59 anos  ou 1,80% a.a. a partir de 60 anos</td></tr>
						<tr>
							<td>7. Data de Vencimento do primeiro pagamento mensal: 20/".proxMes($asscontrato)."/".proxMesAno($asscontrato)."</td>
						</tr>
						<tr>
		...
		$quadro_nove="<b>
					IX – SEGURO DE DANOS FÍSISCOS AO IMÓVEL</b><br>					
					<table border='1' width='728'>
						<tr>
							<td>1. Valor do primeiro prêmio anual: R$ ".formataMoeda($vl_premio)."</td>
						</tr>
						<tr>
							<td>2. Data do pagamento: 20/".proxMes($asscontrato)."/".proxMesAno($asscontrato)."</td>
						</tr>
					</table><br>";
		$quadro_dez="<b>
		...
		$quadro_doze="<b>
					INFORMAÇÕES ADICIONAIS</b><br><br><p align='justify' >".$infofort." </p>
	...
	$fixa=" <hr>
				...
				<p align='justify'>
										O montante total do Saldo Devedor (conforme definido na cláusula 4.1.) será atualizado, desde a presente data e com periodicidade mensal pela aplicação da variação mensal do indexador do índice de referência adotado para o segmento de empréstimos e financiamentos, estabelecido na política de investimento do Plano PREVI Futuro, com defasagem de 2 (dois) meses da data de atualização do saldo devedor ".$dev3."</p>
				<p align='justify'><b>								
										Saldo Devedor</b></p>
				<p align='justify'>			
				...
				<p align='justify'>
										Sobre o Saldo Devedor (conforme definido na cláusula 4.1.), acrescido da atualização monetária nos termos da cláusula 4, incidirão, desde a presente data, e com periodicidade mensal, juros à taxa efetiva mensal estipulada no numero 5 do item VII deste Contrato, correspondentes aos juros do índice de referência adotados para o segmento de empréstimos e financiamentos, estabelecidos na política de investimento do Plano PREVI Futuro, os quais deverão ser pagos mensalmente, conforme previsto na cláusula 7.</p>
				<p align='justify'><b>				
				...
				<p>
							...
							d = indexador do índice de referência adotado para o segmento de empréstimos e financiamentos estabelecido na política de investimento do Plano PREVI Futuro projetado para os próximos 12 (doze) meses<br>
							e = taxa mensal equivalente aos juros do índice de referência adotados para o segmento de empréstimos e financiamentos estabelecidos na política de investimento do Plano PREVI Futuro<br>
				...
				<p align='justify'><u><b>Regulamento PREVI Futuro vigente</b></u></p>		
				<p align='justify'>
				8.4. No caso de rompimento do vinculo empregatício do DEVEDOR com o Banco do Brasil:<br> a) havendo opção pelo cancelamento da inscrição mediante opção pelo resgate, serão aplicadas as regras do Regulamento do Plano PREVI Futuro vigentes à época do cancelamento no que tange à utilização do saldo existente nas reservas patronais de poupança, sendo que, por meio deste ato, o DEVEDOR, expressamente autoriza em qualquer hipótese, a utilização do saldo das contribuições pessoais vertidas para a Parte I e do saldo existente em sua reserva individual de poupança para quitar ou amortizar a dívida oriunda do financiamento imobiliário; caso este saldo não seja suficiente para liquidação da dívida, aplicar-se-á o disposto na cláusula 7.3.1 e cláusula 8.2 deste Contrato;<br> b) havendo opção pela permanência no Plano de Benefícios como participante externo integral, aplicar-se-á o disposto na cláusula 7.3.1. deste Contrato; <br> c) havendo opção pela permanência no Plano de Benefícios como participante externo parcial, 80% dos saldos existentes nas reservas patronais de poupança serão utilizados, na forma prevista no Regulamento do Plano de Benefícios PREVI Futuro para quitar ou amortizar o presente financiamento imobiliário; caso este saldo não seja suficiente para liquidação da dívida, aplicar-se-á o disposto na cláusula 7.3.1 e cláusula 8.2 deste Contrato.</p>
					
			<p align='justify'>
					8.4.1. Em qualquer hipótese, havendo saldo de Empréstimo Simples e de Financiamento Imobiliário liquidar-se-á em primeiro lugar o Empréstimo Simples e, restando disponibilidade de recursos, ocorrerá a liquidação/amortização do Financiamento Imobiliário.</p>
					
		<p align='justify'><u><b>Regulamento PREVI Futuro proposto:</b></u></p>		
				<p align='justify'>
				8.4. No caso de rompimento do vinculo empregatício do DEVEDOR com o Banco do Brasil:<br> a) havendo o cancelamento da inscrição mediante opção pelo resgate, a reserva patronal de poupança, apurada na forma estabelecida no Regulamento do Plano, será utilizada para amortizar e/ou liquidar o financiamento imobiliário; caso o saldo da reserva patronal de poupança não seja suficiente para liquidar a dívida, o DEVEDOR, neste ato expressamente autoriza a utilização do saldo das contribuições pessoais vertidas para a Parte I e do saldo existente em sua reserva individual de poupança para quitar ou amortizar a dívida oriunda do financiamento imobiliário; na hipótese de haver saldo remanescente, aplicar-se-á o disposto na cláusula 7.3.1 e cláusula 8.2 deste Contrato;<br> b) havendo opção pela permanência no Plano de Benefícios como participante externo integral ou como contribuinte externo, aplicar-se-á o disposto na cláusula 7.3.1. deste Contrato. <br> c) havendo o cancelamento da inscrição mediante opção pela portabilidade, será aplicado o disposto no respectivo plano de benefícios relativamente à utilização de reservas para amortização/liquidação de obrigações junto à PREVI; na hipótese de haver saldo remanescente, aplicar-se-á o disposto na cláusula 7.3.1 e cláusula 8.2 deste Contrato;
</p>
			...
			8.4.1. Em qualquer hipótese, havendo saldo de Empréstimo Simples e de Financiamento Imobiliário liquidar-se-á em primeiro lugar o Empréstimo Simples e, restando disponibilidade de recursos, ocorrerá a liquidação/amortização do Financiamento Imobiliário.</p>
				...
				$fixa="<p align='justify'>								
										E, por estarem assim justos e contratados, assinam o presente em 03 (três) vias de igual teor e valor, na presença de 02 (duas) testemunhas.</p>
														<br>
				<p align='justify'>								
										FOLHA DE ASSINATURAS DO CONTRATO DE COMPRA E VENDA DE IMÓVEL COM FINANCIAMENTO, GARANTIA DE ALIENAÇÃO FIDUCIÁRIA E OUTRAS AVENÇAS Nº ".$id_lstn.".</p>
