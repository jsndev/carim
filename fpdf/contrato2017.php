	...
	if($prop_sex=='F')
	{
		if($prop_civil==2)//EST. CIVIL CASADO
		{
			if($prop_reg==1)//Comunhão Parcial de Bens antes da lei
			{
				if($prop_nacional==$conj_nacional)
				{
									$emitente="<b>".maiusculo($prop_nome)." e s/m ".maiusculo($conj_nome)."</b>, ".$nacional.", casados  pelo regime de Comunhão Parcial de Bens,  em ".$prop_dtcasamento.", conforme escritura de pacto antenupcial lavrada no ".$prop_loclavrado.", no Livro ".$prop_livro.", Folhas ".$prop_folha.", em ".$prop_dtlavrado.", registrada sob o nr. ".$prop_numregistro." ".$habens.", ela ".$prop_prof.", ele ".$conj_profissao.", portadores dos Documentos de Identificação n°(s) ".$prop_numdoc.", expedido por ".maiusculo($prop_emissor)." em ".$prop_dtdoc." e ".$conj_numdoc.", expedido por ".maiusculo($conj_emissor)." em ".$conj_dtdoc.", respectivamente, inscritos no CPF/MF sob os nrs. ".$prop_cpf." e ".$conj_cpf.", residentes e domiciliados no(a) ".$endereco." <br>".$procurador;
				}else
				{
			...
			if($prop_reg==7)//Comunhão Parcial de Bens depois da lei
			{
				if($prop_nacional==$conj_nacional)
				{
									$emitente="<b>".maiusculo($prop_nome)." e s/m ".maiusculo($conj_nome)."</b>, ".$nacional.", casados  pelo regime de Comunhão Parcial de Bens,  em ".$prop_dtcasamento.", ela ".$prop_prof.", ele ".$conj_profissao.", portadores dos Documentos de Identificação n°(s) ".$prop_numdoc.", expedido por ".maiusculo($prop_emissor)." em ".$prop_dtdoc." e ".$conj_numdoc.", expedido por ".maiusculo($conj_emissor)." em ".$conj_dtdoc.", respectivamente, inscritos no CPF/MF sob os nrs. ".$prop_cpf." e ".$conj_cpf.", residentes e domiciliados no(a) ".$endereco.", ".$dev1.$procurador;
				}else
				{
			...
			if($prop_reg==3)//Comunhão Universal de Bens depois da lei
			{
				if($prop_nacional==$conj_nacional)
				{
									$emitente="<b>".maiusculo($prop_nome)." e s/m ".maiusculo($conj_nome)."</b>, ".$nacional." , casados pelo regime de Comunhão Universal de Bens, na vigência da Lei n°  6.515/77,  em ".$prop_dtcasamento.", conforme escritura de pacto antenupcial lavrada no ".$prop_loclavrado.", no Livro ".$prop_livro.", Folhas ".$prop_folha.", em ".$prop_dtlavrado.", registrada sob o nr. ".$prop_numregistro." ".$habens.", ela ".$prop_prof.", ele ".$conj_profissao.", portadores dos Documentos de Identificação n°(s) ".$prop_numdoc.", expedido por ".maiusculo($prop_emissor)." em ".$prop_dtdoc." e ".$conj_numdoc.", expedido por ".maiusculo($conj_emissor)." em ".$conj_dtdoc.", respectivamente, inscritos no CPF/MF sob os nrs. ".$prop_cpf." e ".$conj_cpf.", residentes e domiciliados no(a) ".$endereco.", ".$dev1.$procurador;
				}else
				{
		...
		{
				$emitente="<b>".maiusculo($prop_nome)."</b>, ".$emit_nacional.", ".$prop_prof.", ".$estciv.", maior, portadora do Documento de identificação nº ".$prop_numdoc.", emitido por ".maiusculo($prop_emissor)." em ".$prop_dtdoc.", inscrito no CPF/MF sob n° ".$prop_cpf.", residente e domiciliada no(a) ".$endereco.", ".$dev1.$procurador;
		}
		...
		if($vend_tipo[$a]==2){
			...
			while($regvjs = mysql_fetch_array($rsvjs, MYSQL_ASSOC))
			{
				...
				if($vjsocio_sexo[$a][$b]=='M')
				{
					...
					$socio .="<b>Sr. ".maiusculo($vjsocio_nome[$a][$b])."</b>, ".$vjs_nacional[$a][$b].", ".$vjs_estciv[$a][$b].", ".$vjsocio_prof[$a][$b].", portador do Documento de Idenficação nº. ".$vjsocio_nrrg[$a][$b].", emitido por ".$vjsocio_orgrg[$a][$b]." em ".$vjsocio_dtrg[$a][$b].", inscrito no CPF/MF sob nº. ".$vjsocio_cpf[$a][$b].", residente e domiciliado em ".$vjs_cidade[$a][$b]."-".$vjs_uf[$a][$b]."; "; 
				}
				...
				if($vjsocio_sexo[$a][$b]=='F')
				{
					...
					$socio .="<b>Sra. ".maiusculo($vjsocio_nome[$a][$b])."</b>, ".$vjs_nacional[$a][$b].", ".$vjs_estciv[$a][$b].", ".$vjsocio_prof[$a][$b].", portadora do Documento de Idenficação nº. ".$vjsocio_nrrg[$a][$b].", emitido por ".$vjsocio_orgrg[$a][$b]." em ".$vjsocio_dtrg[$a][$b].", inscrita no CPF/MF sob nº. ".$vjsocio_cpf[$a][$b].", residente e domiciliada em ".$vjs_cidade[$a][$b]."-".$vjs_uf[$a][$b];
...
##########################################################################################################		
		...
		$quadro_seis="<b>
					...
					<table border='1' width='728'>
						...
						<tr>
							<td>2. Recursos liberados ao CREDOR QUITANTE (recursos do Financiamento) através de pagamento de Boleto Bancário ou Orpag: R$ ".formataMoeda($rec_crd)."</td>
						</tr>
						<tr>
