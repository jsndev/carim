	...
	while($registro = mysql_fetch_array($result, MYSQL_ASSOC))
	{
		...
		if($vend_tipo[$a]==1){
			...
			//§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
					...
					$vendedor="<b>".maiusculo($vend_nome[$a])."</b>, ".$v_nacional[$a].", ".$v_estciv[$a].", portador da cédula de Identidade nº ".$vendf_nrrg[$a]."-".maiusculo($vendf_orgrg[$a]).", inscrito no CPF/MF sob n° ".$vendf_cpf[$a]."  <b> e ".$vconj_nome[$a]."</b>, ".$vc_nacional[$a].", ".$vcj_estciv[$a].", portador da cédula de Identidade n° ".$vconj_nrrg[$a]."-".maiusculo($vconj_orgrg[$a]).", inscrito no CPF/MF sob n° ".$vconj_cpf[$a].", convivendo em união estável, nos termos da Lei nº. 9.278/96 e alterações do art. 1.723 do Código Civil Brasileiro, residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
...
##########################################################################################################		
		...
		$quadro_um="<b>PREÂMBULO</b><br><br>
					...
					<p align='justify'>FINANCIADOR".$credor.":<br><b>CAIXA DE PREVIDÊNCIA DOS FUNCIONÁRIOS DO BANCO DO BRASIL </b>- entidade fechada de previdência complementar constituída na forma de sociedade civil sem fins lucrativos, inscrita no CNPJ/MF sob o n.º 33.754.482/0001-24 , com sede na cidade do Rio de Janeiro – RJ, doravante denominada PREVI, neste ato representada por sua bastante procuradora <b>ATHOS GESTÃO E SERVIÇOS LTDA.</b>, inscrita no CNPJ/MF sob o n° 00.839.032/001-85 - <b>Matriz</b>, com sede na Avenida Senador Xavier da Silva n° 294, São Francisco, Curitiba-PR e <b>Filial</b> na Rua Amália de Noronha n° 159, Jardim América, São Paulo-SP, inscrita no CNPJ/MF sob o n° 00.839.032/0002-66, neste ato representada por <b>HELENA ALEGRETTI GALLIERA ABOLAFIO</b>, brasileira, divorciada, advogada, portadora do RG n°. 5.978.919/SP, inscrita no CPF/MF sob n° 998.511.648-87, residente e domiciliada em São Paulo, Capital, nos termos das procurações lavradas no 6° Ofício de Notas da Comarca do Rio de Janeiro – RJ, às fls. 183/183v do livro n° 6.665, datada de 17/09/2009 e no 1º Tabelionato de Notas de Curitiba - PR, no Livro 0738-P, Folha 181, datada de 17/02/2009, respectivamente, que são partes integrantes do presente contrato.</p><br>";
