...
$pageTitle = "Adicionar Assistente";
...
if ($crypt->decrypt($_POST["ac"]) == "adicionar") {
	...
	$dadosUsuario["level_usua"] = TPUSER_ADMINISTRATIVO;
	...
	if ($oUsuario->getErrNo() == 0) {
		...
		$mensagem->setMensagem("Assistente cadastrado com sucesso. Um e-mail foi enviado para o assistente contendo sua senha de acesso.", MSG_SUCESSO);
		unset($_POST);
	} elseif ($oUsuario->getErrNo() == DB_ERR_UNIQUE) {
		$mensagem->setMensagem("Já existe ou existiu um assistente cadastrado com esse endereço de e-mail.", MSG_ERRO);
	} else {
		$mensagem->setMensagem("Houve um erro ao cadastrar o assistente. Favor tentar novamente.", MSG_ERRO);
	}
}
?>
...
<div class="quadroInterno">
	...
	<div class="quadroInternoMeio">
		...
		<table cellpadding="0" cellspacing="2" class="tbForm">
			...
			<tr>
				<td>&nbsp;</td>
				<td class="alr"><img src="images/buttons/bt_voltar.gif" onclick="goPage('adm_assistentes.php')" alt="Cancelar e voltar" class="cursorMao" />&nbsp;<img src="images/buttons/bt_salvar.gif" onclick="validaAssistente(document.getElementById('frm1'));" alt="Inserir Assistente" class="cursorMao" /></td>
			</tr>
		</table>
	</div>
