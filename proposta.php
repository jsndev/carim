...
return '<?=date('d/m/Y',time());?>'
     ...
     * Recebida documentação de 2ª fase com prazo para análise de 5 dias úteis - ID 5 (  5 dias uteis ( atraso ATHOS ) )
     * Recebida documentação faltante. Prazo para análise de 2 dias úteis - ID 9 (2 uteis ( atraso ATHOS)
     * Encaminhado e-mail de apto. Segue para operacionalização - ID 7 - 2 dias
     * Proposta operacionalizada, encaminhada para qualificação - ID 10 - 3 dias atraso athos
     */
    ...
    switch ($historico_motivo_id) {
        ...
        case 3:
            $atraso = [
                'motivo' => utf8_decode('Solicitada avaliação do imóvel'),
        ...
        case 9:
            $atraso = [
                'motivo' => utf8_decode('Recebida documentação faltante'),
        ...
        case 7:
            $atraso = [
                'motivo' => utf8_decode('Encaminhado e-mail de apto. Segue para operacionalização'),
                'tempo_atraso' => $data_atual->diff($atualizacao_historico)->days - 2,
                'atrasado' => $data_atual->diff($atualizacao_historico)->days > 2,
                'cor' => 'yellow',
                'responsavel' => 'Athos Gestão'
        ...
        case 10:
            $atraso = [
                'motivo' => utf8_decode('Proposta operacionalizada, encaminhada para qualificação'),
    ...
    <?php if (!empty($atraso) && $atraso['tempo_atraso'] > 0) : ?>
        <div style="font-size: 21px; background-color: <?php echo $atraso['cor'] ?>;  padding: 10px; font-variant: all-small-caps;">
            ...
            Responsável: <?php echo $atraso['responsavel'] ?>
        </div>
    <?php endif; ?>
