...
class proponente extends database {
	...
	function listar() {
		$this->query = "
			SELECT cpf_ppnt,nrrg_ppnt,orgrg_ppnt,dtrg_ppnt,dtnascimento_ppnt,sexo_ppnt,nacional_ppnt,endereco_ppnt,nrendereco_ppnt,cpendereco_ppnt,cep_ppnt,cod_proponente,cod_logr,cod_bairro,cod_uf,cod_municipio,cod_estciv,telefone_ppnt,cod_ppst,vlfinsol_ppnt,przfinsol_ppnt,vlsinal_ppnt,vlentrada_ppnt,vlprestsol_ppnt,vlcompra_ppnt,vlfinaprov_ppnt,vlprestaprov_ppnt,przaprov_ppnt,despachante_ppnt,flgdevsol_ppnt,email_ppnt,profissao_ppnt,flgproc_ppnt,proc_ppnt,flguniest_ppnt,flgescritura_ppnt
			FROM proponente
		";
		$this->query();
		return $this->qrdata;
	...
	function pesquisarPorCpf($cpf) {
		...
		$this->query = "
			SELECT cpf_ppnt,nrrg_ppnt,orgrg_ppnt,dtrg_ppnt,dtnascimento_ppnt,sexo_ppnt,nacional_ppnt,endereco_ppnt,nrendereco_ppnt,cpendereco_ppnt,cep_ppnt,cod_proponente,cod_logr,cod_bairro,cod_uf,cod_municipio,cod_estciv,telefone_ppnt,cod_ppst,vlfinsol_ppnt,przfinsol_ppnt,vlsinal_ppnt,vlentrada_ppnt,vlprestsol_ppnt,vlcompra_ppnt,vlfinaprov_ppnt,vlprestaprov_ppnt,przaprov_ppnt,despachante_ppnt,flgdevsol_ppnt,flgproc_ppnt,proc_ppnt,flguniest_ppnt,flgescritura_ppnt
			FROM proponente
			WHERE
				cpf_ppnt = '".$cpf."'
		";
	...
	function getPaginasProposta() {
		...
		$this->query = "
			SELECT 
				cod_ppst,data_ppst,situacao_ppst,dtapresdoc_ppst,dtiniexigencia_ppst,dtfimexigencia_ppst,dtaprovacao_ppst,dtasscontrato_ppst,dtokregistro_ppst,vlfinsol_ppst,przfinsol_ppst,valordevsinalsol_ppst,pricesac_ppst,valorcompra_ppst,valorfgts_ppst,taxajuros_ppst,valorseguro_ppst,valormanutencao_ppst,vlprestsol_ppst,indcancelamento_ppst,valorboletoaval_ppst,flgboletoavalpago_ppst,dtagend_asscontr_ppst,flgrespostavalor_ppst,dtpagtoboleto_ppst,flgaprovacaoprevi_ppst,dtremessacontrato_ppst,flgpropostaativa_ppst,flgaprovimovel_ppst
			FROM proposta
			WHERE situacao_ppst IN ('".implode("','",$aParams)."') ORDER BY cod_ppst DESC";
		$this->query();
	...
	function incluirProposta($aDados) {
		...
		if (FLG_PREVI == true) {
			...
			if ($retorno === true) {
				...
				$this->inserir(date("Y-m-d H:i:s"),"2","","","","","","","","","","","","","","","","","","","","","","","","","1");
...
//if (!$aDadosProposta['imovel']['dtaprovacao_imov'] && ($aDadosProposta['situacao_ppst'] == "1" || $aDadosProposta['situacao_ppst'] == "3" || $aDadosProposta['situacao_ppst'] == "5")) {
			...
			if ($_POST['frm_cod_ppnt'] != '' && ($aDadosProposta['situacao_ppst'] == "1" || ($aDadosProposta['situacao_ppst'] == "3" && $cLOGIN->iLEVEL_USUA == TPUSER_ATENDENTE) || $aDadosProposta['situacao_ppst'] == "5" || (($_GET['corrigir']=='sim') && $cLOGIN->iLEVEL_USUA == TPUSER_ATENDENTE && $aDadosProposta['situacao_ppst'] > 4 && $aProposta["situacao_ppst"]<8))) {
        ...
        $aDadosVendedor[0]['email_vend'] = $_POST['email_vend'];
			...
			if (($cod_vend != "" && ($aDadosProposta['situacao_ppst'] == "1" || ($aDadosProposta['situacao_ppst'] == "3" && $cLOGIN->iLEVEL_USUA == TPUSER_ATENDENTE) || $aDadosProposta['situacao_ppst'] == "5")) || (($_GET['corrigir']=='sim') && $cLOGIN->iLEVEL_USUA == TPUSER_ATENDENTE && $aDadosProposta['situacao_ppst'] > 4  && $aProposta["situacao_ppst"]<8)) {
				/////////////////////$_POST['vend_tipo'];
				...
				if ($_POST['vend_tipo'] != "") {
					...
					if ($_POST['vend_tipo'] == '1') {
						...
						if ($aDadosVendedorJur) {
							vendjur::atualizarPk($cod_ppst,$cnpj_vjur,$isenpis_vjur,$isencofins_vjur,$isencsll_vjur,$cod_cnae,$cod_vend,$despachante_vjur,$versaoestat_vjur,$dtestat_vjur,$locestat_vjur,$nrregestat_vjur);
						} else {
							vendjur::inserir($cod_ppst,$cnpj_vjur,$isenpis_vjur,$isencofins_vjur,$isencsll_vjur,$cod_cnae,$cod_vend,$despachante_vjur,$versaoestat_vjur,$dtestat_vjur,$locestat_vjur,$nrregestat_vjur);
						}
						...
						if ($sAcao == "saveSocio") {
							...
							if ($_POST['frm_cod_socio']) {
								vendjursocio::atualizarPk($cod_ppst,$cod_vjsoc,$nome_vjsoc,$nick_vjsoc,$endereco_vjsoc,$nrendereco_vjsoc,$cpendereco_vjsoc,$cep_vjsoc,$telefone_vjsoc,$cpf_vjsoc,$sexo_vjsoc,$cod_pais,$cod_logr,$cod_bairro,$cod_uf,$cod_municipio,$cod_vend,$nrrg_vjsoc,$orgrg_vjsoc,$dtrg_vjsoc,$cod_estciv,$cargo_vjsoc);
							} else {
								vendjursocio::inserir($cod_ppst,$nome_vjsoc,$nick_vjsoc,$endereco_vjsoc,$nrendereco_vjsoc,$cpendereco_vjsoc,$cep_vjsoc,$telefone_vjsoc,$cpf_vjsoc,$sexo_vjsoc,$cod_pais,$cod_logr,$cod_bairro,$cod_uf,$cod_municipio,$cod_vend,$nrrg_vjsoc,$orgrg_vjsoc,$dtrg_vjsoc,$cod_estciv,$cargo_vjsoc);
							}
						}
					}
				}
...
class vendjur extends database {
	...
	function listar() {
		$this->query = "
			SELECT cod_ppst,cnpj_vjur,isenpis_vjur,isencofins_vjur,isencsll_vjur,cod_cnae,cod_vend,despachante_vjur,versaoestat_vjur,dtestat_vjur,locestat_vjur,nrregestat_vjur
			FROM vendjur
		";
		$this->query();
		return $this->qrdata;
	...
	function inserir($cod_ppst,$cnpj_vjur,$isenpis_vjur,$isencofins_vjur,$isencsll_vjur,$cod_cnae,$cod_vend,$despachante_vjur,$versaoestat_vjur,$dtestat_vjur,$locestat_vjur,$nrregestat_vjur) {
		$this->query = "
			INSERT INTO vendjur ( cod_ppst,cnpj_vjur,isenpis_vjur,isencofins_vjur,isencsll_vjur,cod_cnae,cod_vend,despachante_vjur,versaoestat_vjur,dtestat_vjur,locestat_vjur,nrregestat_vjur ) VALUES (
				".(!$cod_ppst ? "NULL" : "'".mysql_real_escape_string($cod_ppst)."'").",".(!$cnpj_vjur ? "NULL" : "'".mysql_real_escape_string($cnpj_vjur)."'").",".(!$isenpis_vjur ? "NULL" : "'".mysql_real_escape_string($isenpis_vjur)."'").",".(!$isencofins_vjur ? "NULL" : "'".mysql_real_escape_string($isencofins_vjur)."'").",".(!$isencsll_vjur ? "NULL" : "'".mysql_real_escape_string($isencsll_vjur)."'").",".(!$cod_cnae ? "NULL" : "'".mysql_real_escape_string($cod_cnae)."'").",".(!$cod_vend ? "NULL" : "'".mysql_real_escape_string($cod_vend)."'").",".(!$despachante_vjur ? "NULL" : "'".mysql_real_escape_string($despachante_vjur)."'").",".(!$versaoestat_vjur ? "NULL" : "'".mysql_real_escape_string($versaoestat_vjur)."'").",".(!$dtestat_vjur ? "NULL" : "'".mysql_real_escape_string($dtestat_vjur)."'").",".(!$locestat_vjur ? "NULL" : "'".mysql_real_escape_string($locestat_vjur)."'").",".(!$nrregestat_vjur ? "NULL" : "'".mysql_real_escape_string($nrregestat_vjur)."'")."
			)
		";
		$this->query();
		return $this->qrdata;
...
class vendjursocio extends database {
	...
	function listar() {
		$this->query = "
			SELECT cod_ppst,cod_vjsoc,nome_vjsoc,nick_vjsoc,endereco_vjsoc,nrendereco_vjsoc,cpendereco_vjsoc,cep_vjsoc,telefone_vjsoc,cpf_vjsoc,sexo_vjsoc,cod_pais,cod_logr,cod_bairro,cod_uf,cod_municipio,cod_vend,nrrg_vjsoc,orgrg_vjsoc,dtrg_vjsoc,cod_estciv,cargo_vjsoc
			FROM vendjursocio
		";
		$this->query();
		return $this->qrdata;
	...
	function atualizarPk($cod_ppst,$cod_vjsoc,$nome_vjsoc,$nick_vjsoc,$endereco_vjsoc,$nrendereco_vjsoc,$cpendereco_vjsoc,$cep_vjsoc,$telefone_vjsoc,$cpf_vjsoc,$sexo_vjsoc,$cod_pais,$cod_logr,$cod_bairro,$cod_uf,$cod_municipio,$cod_vend,$nrrg_vjsoc,$orgrg_vjsoc,$dtrg_vjsoc,$cod_estciv,$cargo_vjsoc) {
		$this->query = "
	...
	function inserir($cod_ppst,$nome_vjsoc,$nick_vjsoc,$endereco_vjsoc,$nrendereco_vjsoc,$cpendereco_vjsoc,$cep_vjsoc,$telefone_vjsoc,$cpf_vjsoc,$sexo_vjsoc,$cod_pais,$cod_logr,$cod_bairro,$cod_uf,$cod_municipio,$cod_vend,$nrrg_vjsoc,$orgrg_vjsoc,$dtrg_vjsoc,$cod_estciv,$cargo_vjsoc) {
		$this->query = "
			INSERT INTO vendjursocio ( cod_ppst,nome_vjsoc,nick_vjsoc,endereco_vjsoc,nrendereco_vjsoc,cpendereco_vjsoc,cep_vjsoc,telefone_vjsoc,cpf_vjsoc,sexo_vjsoc,cod_pais,cod_logr,cod_bairro,cod_uf,cod_municipio,cod_vend,nrrg_vjsoc,orgrg_vjsoc,dtrg_vjsoc,cod_estciv,cargo_vjsoc ) VALUES (
				".(!$cod_ppst ? "NULL" : "'".mysql_real_escape_string($cod_ppst)."'").",".(!$nome_vjsoc ? "NULL" : "'".mysql_real_escape_string($nome_vjsoc)."'").",".(!$nick_vjsoc ? "NULL" : "'".mysql_real_escape_string($nick_vjsoc)."'").",".(!$endereco_vjsoc ? "NULL" : "'".mysql_real_escape_string($endereco_vjsoc)."'").",".(!$nrendereco_vjsoc ? "0" : "'".mysql_real_escape_string($nrendereco_vjsoc)."'").",".(!$cpendereco_vjsoc ? "NULL" : "'".mysql_real_escape_string($cpendereco_vjsoc)."'").",".(!$cep_vjsoc ? "NULL" : "'".mysql_real_escape_string($cep_vjsoc)."'").",".(!$telefone_vjsoc ? "NULL" : "'".mysql_real_escape_string($telefone_vjsoc)."'").",".(!$cpf_vjsoc ? "NULL" : "'".mysql_real_escape_string($cpf_vjsoc)."'").",".(!$sexo_vjsoc ? "NULL" : "'".mysql_real_escape_string($sexo_vjsoc)."'").",".(!$cod_pais ? "NULL" : "'".mysql_real_escape_string($cod_pais)."'").",".(!$cod_logr ? "NULL" : "'".mysql_real_escape_string($cod_logr)."'").",".(!$cod_bairro ? "NULL" : "'".mysql_real_escape_string($cod_bairro)."'").",".(!$cod_uf ? "NULL" : "'".mysql_real_escape_string($cod_uf)."'").",".(!$cod_municipio ? "NULL" : "'".mysql_real_escape_string($cod_municipio)."'").",".(!$cod_vend ? "NULL" : "'".mysql_real_escape_string($cod_vend)."'").",".(!$nrrg_vjsoc ? "NULL" : "'".mysql_real_escape_string($nrrg_vjsoc)."'").",".(!$orgrg_vjsoc ? "NULL" : "'".mysql_real_escape_string($orgrg_vjsoc)."'").",".(!$dtrg_vjsoc ? "NULL" : "'".mysql_real_escape_string($dtrg_vjsoc)."'").",".(!$cod_estciv ? "NULL" : "'".mysql_real_escape_string($cod_estciv)."'").",".(!$cargo_vjsoc ? "NULL" : "'".mysql_real_escape_string($cargo_vjsoc)."'")."
			)
		";
		$this->query();
		return $this->qrdata;
