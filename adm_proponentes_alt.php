...
if ((int)$_GET["cod_usua"] > 0) {
	...
	ob_end_clean();
	header("Location: adm_proponentes.php");
	exit();
}
...
if ($crypt->decrypt($_POST["ac"]) == "alterar") {
	...
	if ($oUsuario->getErrNo() == 0) {
		$mensagem->setMensagem("Os dados do proponente foram alterados com sucesso.", MSG_SUCESSO);
		unset($_POST);
	} else {
		$mensagem->setMensagem("Houve um erro ao alterar dos dados do proponente. Favor tentar novamente.", MSG_ERRO);
...
?>
<script language="javascript" type="text/javascript" src="js/cadastroProponente.js.js"></script>
...
<div class="quadroInterno">
	...
	<div class="quadroInternoMeio">
		...
		<table cellpadding="0" cellspacing="2" class="tbForm">
			...
			<tr>
				<td>&nbsp;</td>
				<td class="alr"><img src="images/buttons/bt_voltar.gif" onclick="goPage('adm_proponentes.php')" alt="Cancelar e voltar" class="cursorMao" />&nbsp;<img src="images/buttons/bt_salvar.gif" onclick="validaProponenteAlt(document.getElementById('frm1'));" alt="Inserir Proponente" class="cursorMao" /></td>
			</tr>
		</table>
	</div>
