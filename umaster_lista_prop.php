      ...
      <table cellpadding=0 cellspacing=5 border=0>
        ...
        <tr>
          ...
          <td align="left">
          	...
          	<a href="umaster_lista_prop.php"><img src="images/buttons/bt_limparfiltros.gif" alt="Limpar Filtros" class="im" /></a>
          </td>
        </tr>
      </table>
			</div>
									...
									if($situacao>=3){
										...
										?>
											<tr class="tL<? echo $i%2 ? "1" : "2"; ?>">
												...
												<td><a href='umaster_proposta.php?cod_proposta=<?=$db->qrdata[$i]['cod_ppst'];?>'><? echo $lnk_acao; ?></a></td>
											</tr>
										<?
									}
								}
