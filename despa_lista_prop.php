      ...
      <table cellpadding=0 cellspacing=5 border=0>
        ...
        <tr>
          ...
          <td align="left">
          	...
          	<a href="despa_lista_prop.php"><img src="images/buttons/bt_limparfiltros.gif" alt="Limpar Filtros" class="im" /></a>
          </td>
        </tr>
      </table>
			</div>
		...
		<div class="quadroInterno">
			...
			<?
				...
				$db->query="select 
							...
							and
								d.despachante_ppst='".mysql_real_escape_string($cLOGIN->iID)."'
							and
								situacao_ppst BETWEEN 3 AND 5
							$f_query_nome
							$f_query_matricula
							$f_query_cpf";
				$db->query();
				...
				if($db->qrcount>0){
					...
					<div class="tListDiv listScroll">
						<table>
							<colgroup>
								<col width="150" /><col /><col /><col /><col /><col width="50" />
							</colgroup>
							<thead>
								<tr>
									<td>Data</td>
								...
								for($i=0; $i<$db->qrcount; $i++){
									...
									?>
										<tr class="tL<? echo $i%2 ? "1" : "2"; ?>">
											...
											<td><a href='despa_proposta.php?cod_proposta=<?=$db->qrdata[$i]['cod_ppst'];?>'><? echo $lnk_acao; ?></a></td>
										</tr>
									<?
								}
							?>
