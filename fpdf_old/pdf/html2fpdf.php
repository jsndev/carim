...
function Header($content='')
{
	...
	//$this->RotatedText(25,230,'NÃO NEGOCIÁVEL',50);
	$this->SetTopMargin(20);
	$this->SetAutoPageBreak(true,20);
	$this->Image('/var/www/carim/images/previ_ccb.JPG',10,10,25,10);
	$this->Image('/var/www/carim/images/logo_imobsim.jpg',190,3,10,15);

//	$this->Image('C:/Arquivos de programas/Apache Group/Apache2/htdocs/html/sistemas/carim/images/previ_ccb.JPG',10,10,25,10);
	//$this->Image('C:/Arquivos de programas/Apache Group/Apache2/htdocs/html/sistemas/carim/images/logo_imobsim.jpg',190,3,10,15);
...
//! @desc The header is printed in every page.
  ...
  */
		...
		//$this->Line(10,6,200,6);
		//$this->Cell(30,10,'CENTRAL DE LAUDOS MÉDICOS',0,2,'L');
		
		//$this->SetFont('Arial','B',14);
		//$this->Cell(30,10,'Resultado de Exame',0,0,'L');
		//Line break
		//$this->Ln(17);
...
//! @desc The footer is printed in every page!
	...
	$query="Select cod_proponente from proponente where cod_ppst='".$_GET['cod_proposta']."'";
	$result=mysql_query($query);
	$reg=mysql_fetch_array($result,MYSQL_ASSOC);
	
	$query="Select id_lstn from usuario where cod_usua='".$reg['cod_proponente']."'";
	$result=mysql_query($query);
    ...
    //Page number
	$this->Cell(0,10,"N°:".$registro['id_lstn']."           ".$this->PageNo(),0,0,'R');
	$this->Ln(0);
	//$this->Line(10,6,200,6);
    //Return Font to normal
	$this->Image('/var/www/carim/images/rubricas.JPG',10,278,193,10);
	//$this->Image('C:/Arquivos de programas/Apache Group/Apache2/htdocs/html/sistemas/carim/images/rubricas.JPG',10,278,193,10);
