...
{
	$texto=str_replace("<p>&nbsp;</p>","<br><font color='#FFFFFF'>LN</font><br>",$texto);
...
if($tipo_ppst=='S'){ // Qualificação do Participante de Proposta Simples
	...
	$vltotfinan= (($prop_vlcompra - $prop_vlentrada)  - $vlfgts)+$rec_crd;
	$vlliberado= (($prop_vlcompra - $prop_vlentrada)-$rec_crd) + $vlfgts;
	...
	if($prop_sex=='M')
	{
		if($prop_civil==2)//EST. CIVIL CASADO
		{
			if($prop_reg==1)// Comunhão Parcial de Bens antes da lei
			{
				...
				{
									$emitente="<b>".maiusculo($prop_nome)." e s/m ".maiusculo($conj_nome)."</b>, ele ".$emit_nacional.", ela ".$conjemit_nacional.", casados pelo regime de Comunhão Parcial de Bens,  em ".$prop_dtcasamento.", conforme escritura de pacto antenupcial lavrada no ".$prop_lavrareg.", no Livro ".$prop_lvreg.", Folhas ".$prop_flsreg.", em ".$prop_dtreg.", registrada sob o nr. ".$prop_numreg." ".$habens.", ele bancário, ela ".$conj_profissao.", portadores das carteiras  de identidade nrs. ".$prop_numdoc." e ".$conj_numdoc.", expedidas por ".maiusculo($prop_emissor)."/".maiusculo($conj_emissor).", respectivamente, inscritos no CPFMF sob os nrs. ".$prop_cpf." e ".$conj_cpf.", residentes e domiciliados no(a) ".$endereco.", ".$dev1.$procurador;
				}
			}
		...
		{
				$emitente="<b>".maiusculo($prop_nome)."</b>, ".$estciv.", convivendo em união estável, nos termos da Lei nº. 9.278/96 e alterações do art. 1.723 do Código Civil Brasileiro com ".$conj_nome.", ".$estciv.", ele bancário, ela ".$conj_profissao.", portadores das carteiras  de identidade nrs. ".$prop_numdoc." e ".$conj_numdoc.", expedidas por ".maiusculo($prop_emissor)."/".maiusculo($conj_emissor).", respectivamente, inscritos no CPFMF sob os nrs. ".$prop_cpf." e ".$conj_cpf.", residentes e domiciliados no(a) ".$endereco.", ".$dev1.$procurador;
	...
	if($prop_sex=='F')
	{
		if($prop_civil==2)//EST. CIVIL CASADO
		{
			if($prop_reg==1)//Comunhão Parcial de Bens antes da lei
			{
				...
				{
									$emitente="<b>".maiusculo($prop_nome)." e s/m ".maiusculo($conj_nome)."</b>, ela ".$emit_nacional.", ele ".$conjemit_nacional.", casados pelo regime de Comunhão Parcial de Bens,  em ".$prop_dtcasamento.", conforme escritura de pacto antenupcial lavrada no ".$prop_lavrareg.", no Livro ".$prop_lvreg.", Folhas ".$prop_flsreg.", em ".$prop_dtreg.", registrada sob o nr. ".$prop_numreg." ".$habens.", ela bancária, ele ".$conj_profissao.", portadores das carteiras  de identidade nrs. ".$prop_numdoc." e ".$conj_numdoc.", expedidas por ".maiusculo($prop_emissor)."/".maiusculo($conj_emissor).", respectivamente, inscritos no CPFMF sob os nrs. ".$prop_cpf." e ".$conj_cpf.", residentes e domiciliados no(a) ".$endereco." <br>".$procurador;
				}
			}
			if($prop_reg==7)//Comunhão Parcial de Bens depois da lei
			{
			...
			if($prop_reg==3)//Comunhão Universal de Bens depois da lei
			{
				if($prop_nacional==$conj_nacional)
				{
									$emitente="<b>".maiusculo($prop_nome)." e s/m ".maiusculo($conj_nome)."</b>, ".$nacional." , casados pelo regime de Comunhão Universal de Bens,  em ".$prop_dtcasamento.", conforme escritura de pacto antenupcial lavrada no ".$prop_lavrareg.", no Livro ".$prop_lvreg.", Folhas ".$prop_flsreg.", em ".$prop_dtreg.", registrada sob o nr. ".$prop_numreg." ".$habens.", ela bancária, ele ".$conj_profissao.", portadores das carteiras  de identidade nrs. ".$prop_numdoc." e ".$conj_numdoc.", expedidas por ".maiusculo($prop_emissor)."/".maiusculo($conj_emissor).", respectivamente, inscritos no CPFMF sob os nrs. ".$prop_cpf." e ".$conj_cpf.", residentes e domiciliados no(a) ".$endereco.", ".$dev1.$procurador;
				}else
				{
									$emitente="<b>".maiusculo($prop_nome)." e s/m ".maiusculo($conj_nome)."</b>, ela ".$emit_nacional.", ele ".$conj_nacional.", casados pelo regime de Comunhão Universal de Bens,  em ".$prop_dtcasamento.", conforme escritura de pacto antenupcial lavrada no ".$prop_lavrareg.", no Livro ".$prop_lvreg.", Folhas ".$prop_flsreg.", em ".$prop_dtreg.", registrada sob o nr. ".$prop_numreg." ".$habens.", ela bancária, ele ".$conj_profissao.", portadores das carteiras  de identidade nrs. ".$prop_numdoc." e ".$conj_numdoc.", expedidas por ".maiusculo($prop_emissor)."/".maiusculo($conj_emissor).", respectivamente, inscritos no CPFMF sob os nrs. ".$prop_cpf." e ".$conj_cpf.", residentes e domiciliados no(a) ".$endereco.", ".$dev1.$procurador;
				}
		...
		if($prop_civil!=2 && $flguniest=='S')
		{
				$emitente="<b>".maiusculo($prop_nome)."</b>, ".$estciv.", convivendo em união estável, nos termos da Lei nº. 9.278/96 e alterações do art. 1.723 do Código Civil Brasileiro com ".$conj_nome.", ".$estciv.", ela bancário, ele ".$conj_profissao.", portadores das carteiras  de identidade nrs. ".$prop_numdoc." e ".$conj_numdoc.", expedidas por ".maiusculo($prop_emissor)."/".maiusculo($conj_emissor).", respectivamente, inscritos no CPFMF sob os nrs. ".$prop_cpf." e ".$conj_cpf.", residentes e domiciliados no(a) ".$endereco.", ".$dev1.$procurador;
	...
	while($registro = mysql_fetch_array($result, MYSQL_ASSOC))
	{
		...
		if($vend_tipo[$a]==1){
			...
			$regvf = mysql_fetch_array($rsvf, MYSQL_ASSOC);
				...
				$rsvfprof =mysql_query($qrvfpais);
				$regvfprof = mysql_fetch_array($rsvfprof, MYSQL_ASSOC);
					$v_profissao[$a] = $regvfprof['DESC_PROF'];
			...
			$regvfc = mysql_fetch_array($rsvfc, MYSQL_ASSOC);
				...
				$rsvfcprof =mysql_query($qrvfcpais);
				$regvfcprof = mysql_fetch_array($rsvfcprof, MYSQL_ASSOC);
					$vc_profissao[$a] = $regvfcprof['DESC_PROF'];
			...
			//§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
					...
					if($vendf_sex[$a]=='M')// Vendedor PF Masculino
					{
						if($vendf_estciv[$a]==2)//EST. CIVIL CASADO
						{
							...
							if($vconj_regime[$a]==7)//Comunhão Parcial de Bens depois da lei
							{
								if($vendf_nacional[$a]==$vconj_nacional[$a])
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ".$vnacional[$a]." ,casados pelo regime de Comunhão Parcial de Bens,  em ".$vconj_dtcasamento[$a].", ele ".$v_profissao[$a].", ela ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}else
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ele ".$v_nacional[$a].", ela ".$vc_nacional[$a].", casados pelo regime de Comunhão Parcial de Bens,  em ".$vconj_dtcasamento[$a].", ele ".$v_profissao[$a].", ela ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}
							...
							if($vconj_regime[$a]==2)//Comunhão Universal de Bens antes da lei
							{
								if($vendf_nacional[$a]==$vconj_nacional[$a])
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ".$vnacional[$a].", casados pelo regime de Comunhão Universal de Bens,  em ".$vconj_dtcasamento[$a].", ele ".$v_profissao[$a].", ela ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}else
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ele ".$vendf_nacional[$a].", ela ".$vconj_nacional[$a].", casados pelo regime de Comunhão Universal de Bens,  em ".$vconj_dtcasamento[$a].", ele ".$v_profissao[$a].", ela ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}
							}
							if($vconj_regime[$a]==3)//Comunhão Universal de Bens depois da lei
							{
								if($vendf_nacional[$a]==$vconj_nacional[$a])
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ".$vnacional[$a]." , casados pelo regime de Comunhão Universal de Bens,  em ".$vconj_dtcasamento[$a].", conforme escritura de pacto antenupcial lavrada no ".$prop_lavrareg.", no Livro ".$prop_lvreg.", Folhas ".$prop_flsreg.", em ".$prop_dtreg.", registrada sob o nr. ".$prop_numreg." ".$habens.", ele ".$v_profissao[$a].", ela ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}else
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ele ".$vendf_nacional[$a].", ela ".$vconj_nacional[$a].", casados pelo regime de Comunhão Universal de Bens,  em ".$vconj_dtcasamento[$a].", conforme escritura de pacto antenupcial lavrada no ".$prop_lavrareg.", no Livro ".$prop_lvreg.", Folhas ".$prop_flsreg.", em ".$prop_dtreg.", registrada sob o nr. ".$prop_numreg." ".$habens.", ele ".$v_profissao[$a].", ela ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}
							}
							if($vconj_regime[$a]==5)//Separação de Bens com pacto
							{
								if($vendf_nacional[$a]==$vconj_nacional[$a])
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ".$vnacional[$a]." ,casados pelo regime de Separação de Bens,  em ".$vconj_dtcasamento[$a].", conforme escritura de pacto antenupcial lavrada no ".$prop_lavrareg.", no Livro ".$prop_lvreg.", Folhas ".$prop_flsreg.", em ".$prop_dtreg.", registrada sob o nr. ".$prop_numreg." ".$habens.", ele ".$v_profissao[$a].", ela ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}else
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ele ".$vendf_nacional[$a].", ela ".$vconj_nacional[$a].", casados pelo regime de Separação de Bens de Bens,  em ".$vconj_dtcasamento[$a].", conforme escritura de pacto antenupcial lavrada no ".$prop_lavrareg.", no Livro ".$prop_lvreg.", Folhas ".$prop_flsreg.", em ".$prop_dtreg.", registrada sob o nr. ".$prop_numreg." ".$habens.", ele ".$v_profissao[$a].", ela ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}
							}
							if($vconj_regime[$a]==6)//Separação de Bens obrigatórioa
							{
								if($vendf_nacional[$a]==$vconj_nacional[$a])
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ".$vnacional[$a]." ,casados pelo regime de Separação Obrigatória de bens, nos termos do artigo 1641 do Código Civil Brasileiro,  em ".$vconj_dtcasamento[$a].", ele ".$v_profissao[$a].", ela ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}else
								{
					...
					if($vendf_sex[$a]=='F')// Vendedor PF Feminino
					{
						if($vendf_estciv[$a]==2)//EST. CIVIL CASADO
						{
							...
							if($vconj_regime[$a]==7)//Comunhão Parcial de Bens depois da lei
							{
								if($vendf_nacional[$a]==$vconj_nacional[$a])
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ".$vnacional[$a]." ,casados pelo regime de Comunhão Parcial de Bens,  em ".$vconj_dtcasamento[$a].", ela ".$v_profissao[$a].", ele ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}else
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ela ".$v_nacional[$a].", ele ".$vc_nacional[$a].", casados pelo regime de Comunhão Parcial de Bens,  em ".$vconj_dtcasamento[$a].", ela ".$v_profissao[$a].", ele ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}
							...
							if($vconj_regime[$a]==2)//Comunhão Universal de Bens antes da lei
							{
								if($vendf_nacional[$a]==$vconj_nacional[$a])
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ".$vnacional[$a].", casados pelo regime de Comunhão Universal de Bens,  em ".$vconj_dtcasamento[$a].", ela ".$v_profissao[$a].", ele ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}else
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ela ".$vendf_nacional[$a].", ele ".$vconj_nacional[$a].", casados pelo regime de Comunhão Universal de Bens,  em ".$vconj_dtcasamento[$a].", ela ".$v_profissao[$a].", ele ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}
							}
							if($vconj_regime[$a]==3)//Comunhão Universal de Bens depois da lei
							{
								if($vendf_nacional[$a]==$vconj_nacional[$a])
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ".$vnacional[$a]." , casados pelo regime de Comunhão Universal de Bens,  em ".$vconj_dtcasamento[$a].", conforme escritura de pacto antenupcial lavrada no ".$prop_lavrareg.", no Livro ".$prop_lvreg.", Folhas ".$prop_flsreg.", em ".$prop_dtreg.", registrada sob o nr. ".$prop_numreg." ".$habens.", ela ".$v_profissao[$a].", ele ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}else
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ela ".$vendf_nacional[$a].", ele ".$vconj_nacional[$a].", casados pelo regime de Comunhão Universal de Bens,  em ".$vconj_dtcasamento[$a].", conforme escritura de pacto antenupcial lavrada no ".$prop_lavrareg.", no Livro ".$prop_lvreg.", Folhas ".$prop_flsreg.", em ".$prop_dtreg.", registrada sob o nr. ".$prop_numreg.", ela ".$v_profissao[$a].", ele ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}
							}
							if($vconj_regime[$a]==5)//Separação de Bens com pacto
							{
								...
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ela ".$vendf_nacional[$a].", ele ".$vconj_nacional[$a].", casados pelo regime de Separação de Bens de Bens,  em ".$vconj_dtcasamento[$a].", conforme escritura de pacto antenupcial lavrada no ".$prop_lavrareg.", no Livro ".$prop_lvreg.", Folhas ".$prop_flsreg.", em ".$prop_dtreg.", registrada sob o nr. ".$prop_numreg.", ela ".$v_profissao[$a].", ele ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}
							}
							if($vconj_regime[$a]==6)//Separação de Bens obrigatórioa
							{
								if($vendf_nacional[$a]==$vconj_nacional[$a])
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ".$vnacional[$a]." ,casados pelo regime de Separação Obrigatória de bens, nos termos do artigo 1641 do Código Civil Brasileiro,  em ".$vconj_dtcasamento[$a].", ela ".$v_profissao[$a].", ele ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}else
								{
					...
					if($vendf_estciv[$a]!=2 && $vendf_flguniest[$a]=='S')
					{
							$vendedor .="<b>".maiusculo($vend_nome[$a])."</b>, ".$v_estciv[$a].", convivendo em união estável, nos termos da Lei nº. 9.278/96 e alterações do art. 1.723 do Código Civil Brasileiro com ".$vconj_nome[$a].", ".$vcj_estciv[$a].", ela ".$v_profissao[$a].", ele ".$vc_profissao[$a].", portadores das carteiras  de identidade nrs. ".$vendf_nrrg[$a]." e ".$vconj_nrrg[$a].", expedidas por ".maiusculo($vendf_orgrg[$a])."/".maiusculo($vconj_orgrg[$a]).", respectivamente, inscritos no CPFMF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
...
// montando a tabela
		echo "<table border='0'  bordercolor='#000000'  cellspacing='0' width='600'>
					<tr>
						<td align='center'><font color='#FFFFFF'><b>CONTRATO DE COMPRA E VENDA DE IMÓVEL COM FINANCIAMENTO, ALIENAÇÃO FIDUCIÁRIA DE IMÓVEL E OUTRAS AVENÇAS - Nº ".$id_lstn."<b></font></td>
					</tr>
				</table><br>";
		echo "<font color='#FFFFFF'><b>PREÂMBULO</b><br><br>
		
					<b>QUADRO I – PARTES</b><br><br>
					
					COMPRADOR(ES)</font><br>					
					<table border='0'  bordercolor='#000000'  cellspacing='0' width='600'>
						<tr align='justify'>
							<td align='justify'><font color='#FFFFFF'>".$emitente."</font></td>
						</tr>
					</table><br>";
		echo "<font color='#FFFFFF'>
					...
					<table border='0'  bordercolor='#000000'  cellspacing='0' width='600'>
						<tr>
							<td align='justify'><font color='#FFFFFF'>".$vendedor."</font><font color='#FFFFFF'>LN</font><br>
