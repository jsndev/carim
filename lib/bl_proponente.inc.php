...
if(sizeof($erroFinanciamento)==1){
	$mensagemErro=($ippnt==1)?'Valor de Financiamento proposto maior que Limite Autorizado.':'Valor de Financiamento proposto de ' . $erroFinanciamento[0] . ' é  maior que Limite Autorizado.';
?>
		alert('<?=$mensagemErro;?>');
<?php
	}else{
...
?>
		alert('Valor de Financiamento proposto de <?=$lista;?> é  maior que Limite Autorizado.');
<?php
	}
?>
	</script>
