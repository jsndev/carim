		...
		<div class="quadroInternoMeio">
			<div id="div_add_vend" style="<?php echo $displayDetsVend;?>">
				<div class="grupoDados" style="margin:0px 0px 10px 0px;">
					<?php
						$just_display = false;
						include "alt_form_vendedor.inc.php";
						$just_display = true;
					?>
	    	</div>
    	</div>
									...
									?>
										<tr class="tL<?php echo $ivnd%2 ? "1" : "2"; ?>">
											...
											<td class="alc">
												...
												<?php } ?>
												<img src="images/buttons/bt_alterarmini.gif"  alt="Alterar"  class="im" onclick="corrigirVend('<?php echo $vVend["cod_vend"];?>','<?php echo $crypt->encrypt('altVend');?>');" />
											</td>
										</tr>
