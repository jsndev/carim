...
<div id="div_pf" style="<?php echo $display_dados_pf;?>">
  <table cellpadding=0 cellspacing=5 border=0>
    ...
    <tr>
      ...
      <td align="left"  valign="top">
      	<input type="text" style="width:150px;" name="vend_rg" id="vend_rg" value="<?php echo $aAltVend["vendfis"][0]["nrrg_vfisica"];?>" onKeyDown="return teclasRG(this,event);" onKeyUp="return mascaraRG(this,event);" maxlength="13">&nbsp;
      	Emissão:<?php $utils->obrig('vend_dtrg'); ?>
      	...
      	Órgão Emissor:<?php $utils->obrig('vend_orgrg'); ?>
    ...
    <tr>
	  ...
	  <tr id="tr_casam_dt_aquis" style="<?php echo $display_dados_estciv_vend;?>">
	    <td align="right" valign="top">Dt. Aquisição do Imóvel:<?php $utils->obrig('dtaquisimov_vfisica'); ?></td>
...
<div id="div_pj" style="<?php echo $display_dados_pj;?>">
  <table cellpadding=0 cellspacing=5 border=0>
    ...
    <tr>
      <td align="right" valign="top">Nº de Registro:<?php $utils->obrig('nrregestat_vjur'); ?></td>
...
<table cellpadding=0 cellspacing=5 border=0>
  ...
  <tr>
    <td align="right" valign="top">Bairro:<?php $utils->obrig('cod_bairro_vend'); ?></td>
    <td align="left"  valign="top">
  ...
  <tr>
    ...
    <td align="left"  valign="top"><input type="text" style="width:150px;" name="vend_cep" id="vend_cep" value="<?php echo $utils->formataCep($aAltVend["cep_vend"]);?>" onKeyDown="return teclasInt(this,event);" onKeyUp="return mascaraCEP(this,event);" maxlength="9"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="right" valign="top">Conta Corrente:<?php $utils->obrig('vend_nrcc'); ?></td>
    <td align="left"  valign="top">
...
<div id="div_conjuje_vend" class="grupoDados" style="<?php echo $display_dados_estciv_vend;?>">
    ...
    <tr>
      ...
      <td align="left"  valign="top">
		...
		<tr>
			...
			<td align="left"  valign="top">
				<input type="text" style="width:150px;" name="vend_nrrg_ppcj" id="vend_nrrg_ppcj" value="<?php echo $aAltVend["vendfisconjuge"][0]["nrrg_vfcj"];?>" onKeyDown="return teclasRG(this,event);" onKeyUp="return mascaraRG(this,event);" maxlength="13">&nbsp;
				Emissão:<?php $utils->obrig('vend_dtrg_ppcj'); ?>
				...
				Órgão Emissor:<?php $utils->obrig('vend_orgrg_ppcj'); ?>
		...
		<tr id="tr_vend_conj_trab_admissao" style="<?php echo $display_dets_trab_conj_2;?>">
			<td align="right" valign="top">Data de Admissão:<?php $utils->obrig('vend_dtadmissaoemp_ppcj'); ?></td>
    ...
    <tr id="tr_vend_conj_trab_endereco" style="<?php echo $display_dets_trab_conj_2;?>">
      <td align="right" valign="top">Endereço:<?php $utils->obrig('vend_enderecoemp_ppcj'); ?></td>
    ...
    <tr id="tr_vend_conj_trab_end_num" style="<?php echo $display_dets_trab_conj_2;?>">
      <td align="right" valign="top">Número:<?php $utils->obrig('vend_numeroemp_ppcj'); ?></td>
    ...
    <tr id="tr_vend_conj_trab_bairro" style="<?php echo $display_dets_trab_conj_2;?>">
      ...
      <td align="left"  valign="top">
		...
		<tr id="tr_vend_conj_trab_salario" style="<?php echo $display_dets_trab_conj_2;?>">
			<td align="right" valign="top">Salário:<?php $utils->obrig('vend_salarioemp_ppcj'); ?></td>
...
<div style="text-align:right; margin-top:10px;">
	<?php if($acaoProposta=='altVend'||$acaoProposta=='altSocio'){ ?>
		<img src="images/buttons/bt_salvar.gif"   id="bt_save_vend"   alt="Salvar Vendedor" class="im" onClick="salvarCorrigirVend('<?php echo $crypt->encrypt('saveVend');?>');" />
	<?php }else{ ?>
