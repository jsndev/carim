...
<table cellpadding=0 cellspacing=5 border=0 class="tb_dets_list">
	...
	?>
	<tr>
	  <td align="right" valign="top">Agência:</td><td align="left"><b><?=$ag;?></b></td>
	</tr>
	<tr>
	...
	<td align="left"  valign="top"><b><?php echo $registroPpnt["nrrg_ppnt"];?>&nbsp;&nbsp;&nbsp;&nbsp;</b>
		Emissão: <b><?php echo $utils->formataDataBRA($registroPpnt["dtrg_ppnt"]);?>&nbsp;&nbsp;&nbsp;&nbsp;</b>
		Órgão Emissor: <b><?php echo $registroPpnt["orgrg_ppnt"];?></b>
	</td>
 </tr>
	...
	if ($registroPpnt["cod_estciv"]!=2){ ?>
	  <tr>
    <td align="right" valign="top">Vive em União Estável:</td>
    <td align="left"  valign="top"><?php 	if($registroPpnt["flguniest_ppnt"]=='S') echo "<b>Sim</b>"; else echo "<b>Não</b>";
			  ?>
</td>
  </tr>
  	  <tr>
    <td align="right" valign="top">Possui Escritura:</td>
    <td align="left"  valign="top"><?php 	if($registroPpnt["flgescritura_ppnt"]=='S') echo "<b>Sim</b>"; else echo "<b>Não</b>";
			  ?>
</td>
  </tr>
	...
	<tr>
	 ...
	 if(($registroPpnt["cod_estciv"]==2 && ($registroPpnt["conjuge"][0]["regimebens_ppcj"]==1 || $registroPpnt["conjuge"][0]["regimebens_ppcj"]==3 || $registroPpnt["conjuge"][0]["regimebens_ppcj"]==5)) || $registroPpnt["flgescritura_ppnt"]=='S'){ ?>
		...
		<tr>
			<td align="right" valign="top">Há Bens:</td>
			<td align="left"  valign="top">			  
			<?php if($registroPpnt["conjugepacto"][0]["habens_pcpa"]=='S') echo "<b>Sim</b>";
				  if($registroPpnt["conjugepacto"][0]["habens_pcpa"]=='N') echo "<b>Não</b>";
				  ?>
			</td>
		</tr>
		<?php
			...
			?>
				<tr>
					...
					<td align="left"  valign="top"><b><?php echo $registroPpnt["conjugepacto"][0]["habenscart_pcpa"];?>º Cartório de Registro de Imóveis de <?php echo $aAltPpnt["conjugepacto"][0]["habensloccart_pcpa"];?></b></tr>
				<tr>
	...
	<tr>
	  <td align="right" valign="top">Profissão:</td><td align="left"><b><?=$registroPpnt["profissao_ppnt"];?></b></td>
	</tr>
		...
		<?php
          	...
          	if($registroPpnt["flgproc_ppnt"]=='S') echo "Sim"; else echo "Não";
			  ?></b>
		</td>
	</tr>
...
<div id="div_conjuje" class="grupoDados">
	...
	<? if($registroPpnt["conjuge"][0]["flgtrabalha_ppcj"]=='S'){ /* ?>
		...
		<tr>
		  <td align="right" valign="top">Profissão:</td><td align="left"><b><?=$registroPpnt["conjuge"][0]["cargoemp_ppcj"];?></b></td>
		</tr><? /*
		<tr>
...
<a name="fgts"></a>
		...
		<td colspan="4" ><font color="#993300">
			...
			if($db->qrcount>0)
			{
				...
				while($e<=$f)
				{
					...
					echo "<b>CÓDIGO DE RECUSA:</b> ".$cod[$e]." (".$reg['MSG_ERRO'].")<br>"; 
					$e++;
				}
				echo "<br><br>";
			}
	...
	<tr>
      ...
      <td align="left"  valign="top"><b><? if ($aAltPpnt["flgfgts_ppnt"]=="S"){echo "SIM";}else{echo "NÃO";} ?></b>
      </td>
    </tr>
   <?php
