	...
	while($registro = mysql_fetch_array($result, MYSQL_ASSOC))
	{
		...
		if($vend_tipo[$a]==1){
			...
			//§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
					...
					if($vendf_sex[$a]=='M')// Vendedor PF Masculino
					{
						if($vendf_estciv[$a]==2)//EST. CIVIL CASADO
						{
							...
							if($vconj_regime[$a]==6)//Separação de Bens obrigatórioa
							{
								if($vendf_nacional[$a]==$vconj_nacional[$a])
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ".$vnacional[$a]." ,casadosssss pelo regime de Separação Obrigatória de bens, nos termos do artigo 1641 do Código Civil Brasileiro,  em ".$vconj_dtcasamento[$a].", ele ".$v_profissao[$a].", ela ".$vconj_cargoemp[$a].", portadores do Documento de Identificação n°(s) ".$vendf_nrrg[$a].", emitido por ".maiusculo($vendf_orgrg[$a])." em ".$vendf_dtrg[$a]." e ".$vconj_nrrg[$a].", emitido por ".maiusculo($vconj_orgrg[$a])." em ".$vconj_dtrg[$a].", respectivamente, inscritos no CPF/MF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}else
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ele ".$v_nacional[$a].", ela ".$vc_nacional[$a].", casadosssss pelo regime de Separação Obrigatória de bens, nos termos do artigo 1641 do Código Civil Brasileiro,  em ".$vconj_dtcasamento[$a].", ele ".$v_profissao[$a].", ela ".$vconj_cargoemp[$a].", portadores do Documento de Identificação n°(s) ".$vendf_nrrg[$a].", emitido por ".maiusculo($vendf_orgrg[$a])." em ".$vendf_dtrg[$a]." e ".$vconj_nrrg[$a].", emitido por ".maiusculo($vconj_orgrg[$a])." em ".$vconj_dtrg[$a].", respectivamente, inscritos no CPF/MF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}
							}
					...
					if($vendf_sex[$a]=='F')// Vendedor PF Feminino
					{
						if($vendf_estciv[$a]==2)//EST. CIVIL CASADO
						{
							...
							if($vconj_regime[$a]==6)//Separação de Bens obrigatórioa
							{
								if($vendf_nacional[$a]==$vconj_nacional[$a])
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ".$vnacional[$a]." ,casadossssss pelo regime de Separação Obrigatória de bens, nos termos do artigo 1641 do Código Civil Brasileiro,  em ".$vconj_dtcasamento[$a].", ela ".$v_profissao[$a].", ele ".$vconj_cargoemp[$a].", portadores do Documento de Identificação n°(s) ".$vendf_nrrg[$a].", emitido por ".maiusculo($vendf_orgrg[$a])." em ".$vendf_dtrg[$a]." e ".$vconj_nrrg[$a].", emitido por ".maiusculo($vconj_orgrg[$a])." em ".$vconj_dtrg[$a].", respectivamente, inscritos no CPF/MF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}else
								{
													$vendedor .="<b>".maiusculo($vend_nome[$a])." e s/m ".maiusculo($vconj_nome[$a])."</b>, ela ".$v_nacional[$a].", ele ".$vc_nacional[$a].", casadossssss pelo regime de Separação Obrigatória de bens, nos termos do artigo 1641 do Código Civil Brasileiro,  em ".$vconj_dtcasamento[$a].", ela ".$v_profissao[$a].", ele ".$vconj_cargoemp[$a].", portadores do Documento de Identificação n°(s) ".$vendf_nrrg[$a].", emitido por ".maiusculo($vendf_orgrg[$a])." em ".$vendf_dtrg[$a]." e ".$vconj_nrrg[$a].", emitido por ".maiusculo($vconj_orgrg[$a])." em ".$vconj_dtrg[$a].", respectivamente, inscritos no CPF/MF sob os nrs. ".$vendf_cpf[$a]." e ".$vconj_cpf[$a].", residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
								}
							}
					}//Fim de Vendedor PF Casado
					...
					if($vendf_estciv[$a]!=2 && $vendf_flguniest[$a]=='S')
					{		
					$vendedor.="<b>".maiusculo($vend_nome[$a])."</b>, ".$v_nacional[$a].", ".$v_profissao[$a].", ".$v_estciv[$a].", portador do Documento de Identifcação nº ".$vendf_nrrg[$a].", emitido por ".maiusculo($vendf_orgrg[$a])." em ".$vendf_dtrg[$a].", inscrito no CPF/MF sob n° ".$vendf_cpf[$a]."  <b> e ".$vconj_nome[$a]."</b>, ".$vc_nacional[$a].", ".$vconj_cargoemp[$a].", ".$vcj_estciv[$a].", portador do Documento de Identifcação n° ".$vconj_nrrg[$a].", emitido por ".maiusculo($vconj_orgrg[$a])." em ".$vconj_dtrg[$a].", inscrito no CPF/MF sob n° ".$vconj_cpf[$a].", convivendo em união estável, nos termos da Lei nº. 9.278/96 e alterações do art. 1.723 do Código Civil Brasileiro, residentes e domiciliados no(a) ".$v_endereco[$a].$limite_v;
				
					}elseif($vendf_estciv[$a]!=2 && ($vendf_flguniest[$a]=='N' || $vendf_flguniest[$a]==''))
					{
					$vendedor .="<b>".maiusculo($vend_nome[$a])."</b>, ".$v_nacional[$a].", ".$v_profissao[$a].", ".$v_estciv[$a].", maior, portadora do Documento de Identifcação nº ".$vendf_nrrg[$a].", emitido por ".maiusculo($vendf_orgrg[$a])." em ".$vendf_dtrg[$a].", inscrita no CPF/MF sob o nr. ".$vendf_cpf[$a].", residente e domiciliada no(a) ".$v_endereco[$a].$limite_v;
					}
		...
		if($vend_tipo[$a]==2){
			...
			$vjs_endereco[$a][$b]=$vjs_lograd[$a][$b]." ".$vjsocio_endereco[$a][$b].", nr. ".$vjsocio_numero[$a][$b].", ".$vjsocio_complemento[$a][$b].ucwords(strtolower($vjs_bairro[$a][$b])).", ".ucwords(strtolower($vjs_cidade[$a][$b])).", ".$vjs_uf[$a][$b];	
				...
				if($vjsocio_sexo[$a][$b]=='M')
				{
					...
					$socio .="<b>Sr. ".maiusculo($vjsocio_nome[$a][$b])."</b>, ".$vjs_nacional[$a][$b].", ".$vjs_estciv[$a][$b].", ".$vjsocio_prof[$a][$b].", portador do Documento de Idenficação nº. ".$vjsocio_nrrg[$a][$b].", emitido por ".$vjsocio_orgrg[$a][$b]." em ".$vjsocio_dtrg[$a][$b].", inscrito no CPF/MF sob nº. ".$vjsocio_cpf[$a][$b].", residente e domiciliado em ".$vjs_endereco[$a][$b]."; "; 
				}
				...
				if($vjsocio_sexo[$a][$b]=='F')
				{
					...
					$socio .="<b>Sra. ".maiusculo($vjsocio_nome[$a][$b])."</b>, ".$vjs_nacional[$a][$b].", ".$vjs_estciv[$a][$b].", ".$vjsocio_prof[$a][$b].", portadora do Documento de Idenficação nº. ".$vjsocio_nrrg[$a][$b].", emitido por ".$vjsocio_orgrg[$a][$b]." em ".$vjsocio_dtrg[$a][$b].", inscrita no CPF/MF sob nº. ".$vjsocio_cpf[$a][$b].", residente e domiciliada em ".$vjs_endereco[$a][$b];
