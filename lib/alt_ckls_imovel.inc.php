<? if(count($aProposta["imovel"]["checklist"])>0){ ?>
						...
						if(1){
							...
							<tr class="tL<? echo $i%2 ? "1" : "2"; ?>">
								...
								<td class="alc">
									...
									<img src="images/buttons/calendario.gif" alt="Ver Calendário" class="cursorMao im" onclick="return showCalendar('imv_ckl_doc_dt_ped_<?=$vckImov["cod_mndc"];?>', 'dd/mm/y');" />
								</td>
								<td class="alc">
									...
									<img src="images/buttons/calendario.gif" alt="Ver Calendário" class="cursorMao im" onclick="return showCalendar('imv_ckl_doc_dt_emis_<?=$vckImov["cod_mndc"];?>', 'dd/mm/y');" />
								</td>
	...
	<?
		if($aProposta["imovel"]["municipio"][0]["obschecklist_municipio"]){
			print '<div class="obs_cklist"><b>Observações: </b>'.$aProposta["imovel"]["municipio"][0]["obschecklist_municipio"].'</div>';
		}
	?>
