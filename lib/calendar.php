...
Calendar._TT = {};
//Calendar._TT["TOGGLE"] = "Mude primeiro dia da semana";
Calendar._TT["TOGGLE"] = "Limpar campo";
Calendar._TT["PREV_YEAR"] = "Ano anterior (segure p/ menu)";
Calendar._TT["PREV_MONTH"] = "Mês anterior (segure p/ menu)";
Calendar._TT["GO_TODAY"] = "Ir para hoje";
Calendar._TT["NEXT_MONTH"] = "Próximo mês (segure p/ menu)";
Calendar._TT["NEXT_YEAR"] = "Próximo ano (segure p/ menu)";
