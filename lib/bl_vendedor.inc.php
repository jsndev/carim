...
<div class="bloco_include">
	...
	<div class="quadroInterno">
		...
		<div class="quadroInternoMeio">
								...
								foreach($aProposta["vendedores"] as $kVend=>$vVend){
									...
									?>
										<tr class="tL<?php echo $ivnd%2 ? "1" : "2"; ?>">
											...
											<td class="alc">
												<?php
													if(( $cLOGIN->iLEVEL_USUA == TPUSER_PROPONENTE && $aProposta["situacao_ppst"] == 1) ||	( $cLOGIN->iLEVEL_USUA == TPUSER_ATENDENTE  && ($aProposta["situacao_ppst"]==3 || $aProposta["situacao_ppst"]==5) )
													){
												?>
			...
			<?php 
		if($aProposta["situacao_ppst"]<8 && $cLOGIN->iLEVEL_USUA == TPUSER_ATENDENTE){?>
