...
<form name="filtro" method="post" action="<?=$_SERVER["PHP_SELF"];?>">
		  ...
		  <div class="quadroInternoMeio">
			<?
				...
				if (is_array($aProposta) && @count($aProposta) > 0) {
                    ...
                    <form id="form1" name="agenda" method="post" action="insere_agenda.php">
                      ...
                      <table width="537" border="0">
                        <tr>
                          ...
                          <td width="418"><label>
                            <input type="text" name="agenda_nome" id="agenda_nome" />
                          </label></td>
                        </tr>
                        <tr>
                          <td>Agendamento</td>
                          <td><input type="text" name="agenda_agendamento" id="agenda_agendamento" />
                            <a href="#"
   ...
   name="anchor1" id="anchor1">calend&aacute;rio</a></td>
                        ...
                        <tr>
                          <td colspan="2"><textarea name="agenda_nome2" cols="80" rows="10" id="agenda_nome2"></textarea></td>
                        </tr>
                      </table>
                                        </form>
            <br />
