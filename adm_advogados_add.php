...
if ($crypt->decrypt($_POST["ac"]) == "adicionar") {
	...
	$dadosUsuario["level_usua"] = TPUSER_JURIDICO;
	...
	if ($oUsuario->getErrNo() == 0) {
		...
		$mensagem->setMensagem("Advogado cadastrado com sucesso. Um e-mail foi enviado para o advogado contendo sua senha de acesso.", MSG_SUCESSO);
		unset($_POST);
	} elseif ($oUsuario->getErrNo() == DB_ERR_UNIQUE) {
		$mensagem->setMensagem("Já existe ou existiu um advogado cadastrado com esse endereço de e-mail.", MSG_ERRO);
	} else {
		$mensagem->setMensagem("Houve um erro ao cadastrar o advogado. Favor tentar novamente.", MSG_ERRO);
	}
}
?>
...
<div class="quadroInterno">
	...
	<div class="quadroInternoMeio">
		...
		<table cellpadding="0" cellspacing="2" class="tbForm">
			...
			<tr>
				<td>&nbsp;</td>
				<td class="alr"><img src="images/buttons/bt_voltar.gif" onclick="goPage('adm_advogados.php')" alt="Cancelar e voltar" class="cursorMao" />&nbsp;<img src="images/buttons/bt_salvar.gif" onclick="validaAdvogado(document.getElementById('frm1'));" alt="Inserir Advogado" class="cursorMao" /></td>
			</tr>
		</table>
	</div>
