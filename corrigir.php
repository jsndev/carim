...
<?php
					...
					include "lib/alt_ancoras.inc.php";
					include "lib/bl_proposta.inc.php";
					include "lib/alt_proponente.inc.php";
					include "lib/bl_credor.inc.php";
					include "lib/bl_pagamento.inc.php";
					include "lib/bl_imovel.inc.php";
					include "fckeditor/teste2.php";
					include "lib/alt_vendedor.inc.php";
					//include "lib/bl_aprovproposta.inc.php";
					include "lib/alt_assinatura.inc.php";
					...
					include "lib/alt_botoes.inc.php";
