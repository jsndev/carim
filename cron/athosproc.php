...
if ($iRemessa906in == $iRemessa906out) {
	$aListaProposta = $oProposta->getListaProposta(true, false, true);
				...
				$numppst=$db->qrcount;
						...
						{	
							...
							{ 
								...
								if (count($aDadosProponente["listadenomes"]) > 1) {
									$valor = $aDadosProponente["vlfinsol_ppnt"];
									...
									$valor = $db->qrdata[0]['VLSALDODEV_INTQ'];
								}

								// echo '<br/>======================================';
								// echo 'Verificação de Condomínio';
								// echo '<pre>';
								// var_dump($aDadosProponente["listadenomes"]);
								// echo '</pre>';
								...
								$aBufferInterveniente .= $oArquivo->formatNumber($valor, 15,"0"," ");
							}
						}
