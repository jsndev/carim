      ...
      <table cellpadding=0 cellspacing=5 border=0>
        ...
        <tr>
          ...
          <td align="left">
          	...
          	<a href="lista_limites.php"><img src="images/buttons/bt_limparfiltros.gif" alt="Limpar Filtros" class="im" /></a>
          </td>
        </tr>
      </table>
	  </div>
...
//echo "A mostrar a página " . $pagina . " de " . $total_paginas . "<p>"; 
		...
		<div class="quadroInterno">
			<div><img src="images/layout/subquadro_t.gif" alt=" " /></div>
			<div class="quadroInternoMeio"><p align="center" class="style1">Limites</p>
			<?php
				$filtros = '';
						...
						<table>
							...
							<thead>
								<tr>
									...
									<td align="center">Valor Financiamento</td>
									<td align="center">Parcela</td>
									<td align="center">Prazo</td>
									<td align="center">Convocação</td>
									<td align="center">Prazo</td>
									<td align="center">Expira em</td>
									<td align="center"></td>
								</tr>
							</thead>
							<tbody>
								...
								for($i=0; $i<$db->qrcount; $i++){
									...
									?>
										...
										<tr class="tL<?php echo $i%2 ? "1" : "2"; ?>">
											...
											<td align="center" width='150'><?php echo formataM($db->qrdata[$i]['vlmaxfinan']); ?></td>
											<td align="center"><?php echo formataM($db->qrdata[$i]['parcmaxfinan']); ?></td>
											<td align="center"><?php echo $db->qrdata[$i]['przmaxfinan']; ?> meses</td>
											<td align="center"><?php  echo formataD($db->qrdata[$i]['dtconvocacao']); ?> </td>
											<td align="center" ><?php  ?> 120 dias</td>
											<td align="center" width='150'><?php echo data_expira(formataD($db->qrdata[$i]['dtconvocacao']),120); ?></td>
											<td align="center">
											<input type='hidden' name='cad_matricula' value="<?php echo formataMat($db->qrdata[$i]['id_lstn']); ?>">
											<input type='image' SRC="images/buttons/bt_cadastrar.gif" class='im'></td>
										</tr>
										</form>
									<?php
									}
...
?></p> </form>
   ...
   NAME="anchor1" ID="anchor1">calend&aacute;rio</A></td>
              ...
              <tr>
                <td colspan="2"><p>
                  <textarea name="agenda_historico" cols="100" rows="5" id="agenda_historico"><?php echo $buscaAgenda[0]['historico'];?>
                  </textarea>
                </p>
                  <p>
                    <label>
