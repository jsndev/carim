  ...
  <td style="padding:15px;" valign="top" align="center">
      ...
      if($db->qrcount>0){
        ...
        $ecivil      = $forms->getECivil($ecivil);
			    ...
			    <fieldset style="width:550px;">
			      <legend>Proposta</legend>
		    		<table cellpadding=0 cellspacing=5 border=0>
		    			...
		    			<tr>
		    			  <td align="right" valign="top">Prazo:</td><td align="left"><b><?=$f_przfinsol_ppst;?> mêses</b></td>
		    			</tr>
			    ...
			    <fieldset style="width:550px; margin-top:15px;">
    ...
    <div style="width:550px; margin-top:15px; text-align:left;"><b>Histórico</b></div>
    <div class="listaHistorico" style="height:150px;">
      <?
		$db->query="SELECT
                  h.cod_ppst,
                ...
                WHERE p.proponente_ppst = $f_cod_usua
