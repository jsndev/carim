...
if ($crypt->decrypt($_POST["ac"]) == "adicionar") {
	...
	$dadosUsuario["level_usua"] = TPUSER_ATENDENTE;
	...
	if ($oUsuario->getErrNo() == 0) {
		...
		$mensagem->setMensagem("Atendente cadastrado com sucesso. Um e-mail foi enviado para o atendente contendo sua senha de acesso.", MSG_SUCESSO);
		unset($_POST);
	} elseif ($oUsuario->getErrNo() == DB_ERR_UNIQUE) {
		$mensagem->setMensagem("Já existe ou existiu um atendente cadastrado com esse endereço de e-mail.", MSG_ERRO);
	} else {
		$mensagem->setMensagem("Houve um erro ao cadastrar o atendente. Favor tentar novamente.", MSG_ERRO);
	}
}
?>
...
<div class="quadroInterno">
	...
	<div class="quadroInternoMeio">
		...
		<table cellpadding="0" cellspacing="2" class="tbForm">
			...
			<tr>
				<td>&nbsp;</td>
				<td class="alr"><img src="images/buttons/bt_voltar.gif" onclick="goPage('adm_atendentes.php')" alt="Cancelar e voltar" class="cursorMao" />&nbsp;<img src="images/buttons/bt_salvar.gif" onclick="validaAtendente(document.getElementById('frm1'));" alt="Inserir Atendente" class="cursorMao" /></td>
			</tr>
		</table>
	</div>
