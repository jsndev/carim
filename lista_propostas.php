...
<p>
  <?php
		...
		//caso n?o exista item na agenda, insre
						...
						<table style="width:687px;">
							...
							<thead>
								<tr>
									...
									<td class="alc" style="width: 59px;">Cod. Prop</td>
									<td class="alc" style="width: 200px;">Proponente</td>
									<td class="alc" style="width: 60px;">Cód. Ident. </td>
									<td class="alc" style="width: 90px;">CPF</td>
									<td class="alc" style="width: 150px;">Situação</td>
									<td></td>
								</tr>
							</thead>
							<tbody>
									...
									foreach($vLista["proponentes"] as $kProp=>$vProp){
										?>
											<tr class="tL<?php echo $i%2 ? "1" : "2"; ?>">
												...
												<td class="alr" style="text-align: center;"><?php echo $vProp["cod_ppst"];?></td>
												<td>
												<?php
