...
function Header($content='')
{
	...
	$this->Image('/var/www/html/carim/images/previ_ccb2.JPG',10,10,25,10);
	$this->Ln(10);
	//$this->ADDPage('P');
//! @return void
...
//! @desc The footer is printed in every page!
	...
	$this->Image('/var/www/html/carim/images/rubricas2.JPG',10,278,193,10);
	//$this->Image('C:\Arquivos de programas\Apache Group\Apache2\htdocs\athos\pan\images\rodape_ccb.JPG',10,260,25,45);
